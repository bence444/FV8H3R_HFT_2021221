...
namespace FV8H3R_HFT_2021221.Data
{
    class TinderDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            Messages dlm = new Messages() { Id = 1, MatchId = dl.Id, MessagesSent = new List<string>() { "szia", "szia date?" } };
            Messages hlm = new Messages() { Id = 2, MatchId = hl.Id, MessagesSent = new List<string>() { "szia date?", "szia nem" } };
